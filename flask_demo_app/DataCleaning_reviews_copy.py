...
def all_text_processing(df_start_reviews):
    df_start_reviews["all_text"] = df_start_reviews["reviewText"] + ' ' + df_start_reviews["reviewTitle"]
    ...
    df_processed_reviews = df_start_reviews.drop(['clean_text1','cleanText2','cleanText3','cleanText4','cleanText5','cleanText6'],axis=1)
